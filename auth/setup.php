...
// ---------------------------------------------------------------------------
// 6. users – Verifikationsspalten hinzufügen (idempotent)
// ---------------------------------------------------------------------------
...
if (!$col) {
    ...
    ");
    echo "✓ Spalten 'is_email_verified' und 'email_verified_at' in 'users' ergänzt.\n";
} else {
    echo "✓ Spalten für E-Mail-Verifikation bereits vorhanden.\n";
}
